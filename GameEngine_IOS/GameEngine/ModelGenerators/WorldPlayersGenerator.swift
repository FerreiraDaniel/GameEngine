...
public class WorldPlayersGenerator {
    ...
    private static func getPlayerModel() -> DefaultModelGenerator {
        /* Player model */
        let playerModel = DefaultModelGenerator(objectName: "player", textureName: "player", scale: 0.5, hasTransparency: false, normalsPointingUp: false, atlasFactor: 1);
        return playerModel;
    }
    ...
    public static func getPlayer(loader : Loader) -> Player {
        ...
        let texturedObj : TexturedModel = GenericEntitiesGenerator.getTexturedObj(loader, objName: model.objectName, textureName: model.textureName, hasTransparency: model.hasTransparency, normalsPointingUp: model.normalsPointingUp, atlasFactor: 1);
        ...
        let player : Player = Player(model: texturedObj,
            ...
            textureIndex: 0 //Image index used in case of atlas images
        )
