 ...
 * (Emissive lighting, Ambient lighting, Diffuse, Specular, )
 */
...
public class LightingComponent {
     ...
     * (Note: this is important to separate the GL logic from the model)
     */
     ...
     *
     * @param color The color to set in the component
     */
