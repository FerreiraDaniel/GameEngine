...
public class TerrainTexturesPack {
    ...
    /**
     * @param weightMapTextureId the blendMapTextureId to set
     */
    ...
    /**
     * @param backgroundTextureId the backgroundTextureId to set
     */
    ...
    /**
     * @param mudTextureId the mudTextureId to set
     */
    ...
    /**
     * @param grassTextureId the grassTextureId to set
     */
    ...
    /**
     * @param pathTextureId the pathTextureId to set
     */
