...
public class GenericLoader {
	 ...
	 */
	protected static Vector2f parseVector2f(String xStr, String yStr) {
	 ...
	 * @return The parsed vector
	 */
	protected static Vector3f parseVector3f(String xStr, String yStr, String zStr) {
		float x = Float.parseFloat(xStr);
		float y = Float.parseFloat(yStr);
	 ...
	 */
	protected static String parseStringComponent(String line, String[] currentLine) {
		String fileName = line.substring(currentLine[0].length()).trim();
		return fileName;
	}
}
