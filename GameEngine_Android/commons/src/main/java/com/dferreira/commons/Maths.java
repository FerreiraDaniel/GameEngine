...
public class Maths {
     ...
     *
     * @param v1  First of the vertices of the triangle
     * @param v2  Second of the vertices of the triangle
     * @param v3  Third of the vertices of the triangle
     * @param pos Position the is to determine
