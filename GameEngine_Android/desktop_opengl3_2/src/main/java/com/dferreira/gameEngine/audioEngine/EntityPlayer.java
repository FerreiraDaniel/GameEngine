...
public class EntityPlayer {
     ...
     *
     * @param library  Set of sounds that can use to provide sound feedback to the
     *                 user
     * @param listener Listener to put in a certain position
     * @param player   The player of the scene and also the listener
     */
    ...
    /**
     * @param position1 The position one to take in account
     * @param position2 The position two entity to take in account
     * @param threshold The threshold that is going to use to the match
    ...
    /**
     * @param pPosition The position of player to take in account
     * @param ePosition The position of entity to take in account
     ...
     *
     * @param player   The player of the scene and also the listener
     * @param entities Set of entities that should provide sound feedback
     */
     ...
     * @param player  The position of the player that is going to check the crash
