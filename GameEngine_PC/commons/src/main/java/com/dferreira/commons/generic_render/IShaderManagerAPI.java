...
/**
 * Interface that should be implemented by the interface that makes the access
 * to the Program shader
 */
...
public interface IShaderManagerAPI {
	 ...
	 *
	 * @param shaderProgram
	 *            The program shader not linked yet
	 ...
	 *
	 * @param shaderProgram
	 *            The program shader for which is to bind the attribute
	 ...
	 *
	 * @param shaderProgram
	 *            The shader program to start to use
	 */
	...
	/**
	 * Makes all the preparations to delete a program shader and then delete it
	 *
	 * @param shaderProgram
	 *            The program shader to delete
	 */
