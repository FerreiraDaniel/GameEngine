...
public class Loader {
	 ...
	 */
	public GLRawModel loadToVAO(float[] positions, float[] textureCoords, float[] normals, int[] indices) {
		int vaoID = createVAO();
	...
	private GLRawModel loadPositionsToVAO(float[] positions, int dimensions) {
		...
		unbindVAO();
		return new GLRawModel(vaoId, positions.length / dimensions);
	}
	 ...
	 * @return The rawModel pointing to the created VAO
	 */
	public GLRawModel load2DPositionsToVAO(float[] positions) {
		int dimensions = 2;
	 ...
	 * @return The rawModel pointing to the created VAO
	 */
	public GLRawModel load3DPositionsToVAO(float[] positions) {
		int dimensions = 3;
		return loadPositionsToVAO(positions, dimensions);
	}
