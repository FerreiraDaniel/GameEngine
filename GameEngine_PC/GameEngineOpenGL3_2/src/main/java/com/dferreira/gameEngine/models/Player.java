...
public class Player extends Entity {
	 ...
	 * 
	 * @param timeToRender
	 *            The time that took to render the last frame in seconds like
	 ...
	 *            that the movement of the player is frame rate independent
	 * @param terrain
	 *            Reference to the terrain to compute where is going to fall
	 */
	 ...
	 * 
	 * @param terrain
	 *            Reference to the terrain in order to compute the height that
	 *            is going to jump
	 */
	 ...
	 *            that the movement of the player is frame rate independent
	 * @param terrain
	 *            Terrain used to determine the height where the player is going
	 *            to fall/stay
	 */
