...
public class EntityRender extends GenericRender {
	 ...
	 *            The projection matrix of the render
	 ...
	 *
	 * @param player
	 *            the player_mtl that is to render in the scene
	 */
	...
	private void prepareModel(IRawModel model) {
		frameRenderAPI.prepareModel(model, TEntityAttribute.position, TEntityAttribute.textureCoords,
	...
	private void unPrepareModel() {
		this.frameRenderAPI.unPrepareModel(TEntityAttribute.position, TEntityAttribute.textureCoords,
				TEntityAttribute.normal);
	}
