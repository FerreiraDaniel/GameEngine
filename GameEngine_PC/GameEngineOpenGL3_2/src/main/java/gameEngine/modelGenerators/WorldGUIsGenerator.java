...
import gameEngine.models.GuiShape;
...
public class WorldGUIsGenerator {
	 ...
	 */
	private static GuiTexture getGUI(Loader loader, RawModel rawMode, String textureFileName, float xPosition,
	...
	public static GuiTexture[] getGUIs(Loader loader) {
		...
		RawModel rawModel = loader.load2DPositionsToVAO(guiShape.getVertices());
