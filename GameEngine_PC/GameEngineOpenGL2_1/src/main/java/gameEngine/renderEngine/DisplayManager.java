...
public class DisplayManager {
	...
	public static void createDisplay() {
		 ...
		 // Use a specified version of OpenGL - namely version 2.1
		ContextAttribs attribs = new ContextAttribs(2,1, org.lwjgl.opengl.ContextAttribs.CONTEXT_CORE_PROFILE_BIT_ARB);
		
		try {
			Display.setDisplayMode(new DisplayMode(WIDTH, HEIGHT));
			Display.create(new PixelFormat(), attribs);
			Display.setTitle("Game engine OpenGL 2.1");
